import {AiFillHome, AiFillMessage, AiOutlineCompass, AiOutlineHome, AiOutlineSearch,AiOutlineMessage, AiFillCompass,AiFillHeart,AiOutlineHeart,AiFillPlusCircle,AiOutlinePlusCircle} from 'react-icons/ai';
